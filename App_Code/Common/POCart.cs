...
public partial class POCart
{
    ...
    public static void Clear(string Key)
    {
        ...
        {
            Utils.WriteCookie("ps_cookie_po_cart", "", -43200);
        }
        else
        {
            IDictionary<string, int> dic = GetCart();
    ...
    {
        Utils.WriteCookie("ps_cookie_po_cart", strValue, 43200); //存储一个月
    }
    ...
    {
        return Utils.GetCookie("ps_cookie_po_cart");
    }
