    ...
    public bool IsAdminLogin()
    {
        ...
        else
        {
            ...
            if (adminname != "")
            {
                ...
                Session["VendorID"] = Utils.GetCookie("VendorID");
                Session["DepotCatID"] = Utils.GetCookie("DepotCatID");

                Session["DepotCode"] = Utils.GetCookie("DepotCode");
                Session["ConpanyName"] = Utils.GetCookie("ConpanyName");
                Session["ConpanyCode"] = Utils.GetCookie("ConpanyCode");
                Session["IsDisplayPrice"] = Utils.GetCookie("IsDisplayPrice");
                Session["CustomerSupportURL"] = Utils.GetCookie("CustomerSupportURL");
