<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vendoruser_register.aspx.cs" Inherits="sysmanager_vendoruser_register" %>
...
<dl>
  ...
  <dl  runat="server" visible="false">
    ...
    <dd>
      ...
      <span class="Validform_checktip">*Inactive accoutn can't login system</span>
    </dd>
  </dl>
 <dl>
