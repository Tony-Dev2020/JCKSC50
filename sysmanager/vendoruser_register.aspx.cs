...
public partial class sysmanager_vendoruser_register : System.Web.UI.Page
{
    protected int page;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.vendornum = AXRequest.GetQueryString("vendornum");
        ...
        if(this.vendornum=="")
            ScriptManager.RegisterStartupScript(this, typeof(string), "Error", "alert( 'Vendor nubme is not exist！');window.opener=null;window.open('','_self');window.close();", true);
        if (action == "Edit") //修改
        {
