<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vendoruser_register.aspx.cs" Inherits="vendoruser_register" %>
...
<body>
    ...
    <dd>
      <span class="rule-single-select" style="position:absoulte;z-index:5554; ">
        <asp:DropDownList id="ddlCategoryId" runat="server" datatype="*" errormsg="select company" sucmsg=" " AutoPostBack="True" onselectedindexchanged="ddlCategoryId_SelectedIndexChanged"></asp:DropDownList>
      </span>
       <asp:TextBox ID="txtVendorID" runat="server" CssClass="input normal"></asp:TextBox>
       <asp:TextBox ID="txtVendorName" runat="server" CssClass="input normal"></asp:TextBox>
    </dd>
  </dl>
 
   <dl>
    <dt>User Account</dt> <%--ajaxurl="../tools/admin_ajax.ashx?action=manager_validate"--%>
 ...
 <dl style="visibility:hidden">
  ...
  <dl  style="visibility:hidden">
   ...
   <dl  style="visibility:hidden">
    ...
    <dl runat="server" style="visibility:hidden">
    <dt>Active</dt>
    <dd>
